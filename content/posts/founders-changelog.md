...
- 分享页面使用SSR生成纯静态页面，减少接口请求，且能被搜索引擎索引

Slax Reader 已经是一个很有价值的稍后阅读 + AI 产品，我每天都会花不少于一个小时在上面，阅读我收藏的链接，并且通过与 AI 对话，深化我对信息的理解。
...
我觉得，完全可以直接订阅 Slax Reader 的 Pro 版本啦。当然，不订阅也没问题，只是不能用 AI 功能而已。产品还在快速迭代中，我会时不时地把 Changelog 发出来的。

Slax Reader 的网站：https://r.slax.com

你也可以试试访问某篇我收藏并分享的链接（直接点原文链接也行）：https://reader.slax.com/s/3Db37497bd。
